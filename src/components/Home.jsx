  ...
  const programs = [
    {
      ...
      description: "Scientifically designed programs to burn fat efficiently while preserving lean muscle mass",
    ...
    },
    {
      ...
      description: "Build impressive muscle mass with progressive overload and proven hypertrophy techniques",
    ...
    },
    {
      image:hiittraining,
      title: "HIIT Training",
      description: "High-intensity intervals for maximum calorie burn and cardiovascular conditioning",
    ...
    },
    {
      ...
      description: "Build functional strength and power for athletic performance and daily life",
    ...
    },
    {
      image:boxing,
      title: "Boxing",
      description: "Learn proper technique while getting an incredible full-body workout",
    ...
    },
    {
      image:yoga,
      title: "Yoga",
      description: "Improve flexibility, balance, and mindfulness through ancient practices",
    ...
    },
    {
      image:pilates,
      title: "Pilates",
      description: "Core-focused workouts that enhance stability, posture, and body awareness",
    ...
    },
    {
      image:trx,
      title: "TRX Training",
      description: "Suspension training for functional movement patterns and core stability",
    ...
    },
    {
      image:animal,
      title: "Animal Flow",
      description: "Ground-based movements that improve mobility, stability, and coordination",
    ...
    },
    {
      ...
      description: "Holistic training that connects mental focus with physical movement",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
            AD FITNESS SOLUTIONS is a freelance fitness commerce brand led by certified professional health specialists. Whether you're training solo or in a group, online or offline—we deliver results-driven programs built just for you.
          </p>
        </motion.div>
          ...
          >
            <div className="space-y-6">
              <h3 className="text-3xl md:text-4xl font-bold text-white">
                WHERE <span className="text-[#AD6B08]">PASSION</span> MEETS PURPOSE
              </h3>
              <p className="text-gray-300 text-lg leading-relaxed">
                As a freelance trainer, I offer personalized fitness coaching designed to fit your lifestyle and goals. Whether you're just starting out or looking to level up, I'll guide you with tailored workouts, nutrition tips, and real motivation — online or in person.
              </p>
              <p className="text-gray-400 leading-relaxed">
                This isn't just about fitness — it's about building strength, confidence, and a mindset that lasts. Let's start your journey together.
              </p>
            </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    >
      ...
      <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
        Since 2023, we've been dedicated to providing a dynamic and supportive environment where individuals of all fitness levels can thrive.
      </p>
    </motion.div>
    ...
    <div className="grid lg:grid-cols-3 gap-8 mb-16">
      {[card1, card2, card3].map((img, index) => {
        const titles = ["CHOOSE YOUR GOAL", "GET YOUR CUSTOM PLAN", "TRACK YOUR PROGRESS"];
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="w-14 h-14 bg-orange-500/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    {React.cloneElement(icons[index], { className: "text-[#AD6B08]", size: 24 })}
                  </div>
                ...
                <div className="flex justify-end">
                  <button className="w-12 h-12 bg-transparent border-2 border-[#AD6B08] rounded-full flex items-center justify-center hover:bg-[#AD6B08] transition-all duration-300 group-hover:rotate-45">
                    <ArrowRight className="text-[#AD6B08] hover:text-white" size={18} />
                  </button>
                </div>
              </div>
            </div>
      ...
      {[Award, Activity, Zap].map((Icon, i) => (
        ...
        >
          ...
          <h4 className="text-xl font-bold text-white mb-4">
            {["Personalized Goals", "Expert Coaching", "Real-time Tracking"][i]}
          </h4>
          <p className="text-gray-400 leading-relaxed">
            {
              [
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      >
        <div>
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
            We Have a <span className="text-[#AD6B08]">Great Deal</span> of Experience With <span className="text-[#AD6B08]">Fitness</span>
          </h1>
          <p className="text-[#fff] text-lg leading-relaxed mb-8">
            Meet Aswin Das, a 24-year-old champion bodybuilder and certified personal trainer. 
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-[#DED7A3]/70 max-w-3xl mx-auto leading-relaxed">
            Choose from our comprehensive range of scientifically-backed fitness programs designed to help you achieve your goals faster than ever before
          </p>
        </motion.div>
            ...
            {programs.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors duration-300 ${
                  index === currentSlide ? 'bg-[#A9680B]' : 'bg-gray-600 hover:bg-gray-500'
                }`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-[#DED7A3]/70 max-w-3xl mx-auto leading-relaxed">
            Have questions or ready to start your fitness journey? Reach out to us and we'll get back to you within 24 hours.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-bold text-[#DED7A3] mb-6">Send Us a Message</h3>
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-[#DED7A3]/80 mb-2">Name</label>
                  <input
                    type="text"
                    id="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-[#DED7A3]/80 mb-2">Email</label>
                  <input
                    type="email"
                    id="email"
                    className="w-full bg-gray-800 border border-[#DED7A3]/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#DED7A3]/50"
              ...
              <div>
                <label htmlFor="phone" className="block text-[#DED7A3]/80 mb-2">Phone</label>
                <input
                  type="tel"
                  id="phone"
                  className="w-full bg-gray-800 border border-[#DED7A3]/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#DED7A3]/50"
              ...
              <div>
                <label htmlFor="service" className="block text-[#DED7A3]/80 mb-2">Service Interested In</label>
                <select
                  id="service"
                  className="w-full bg-gray-800 border border-[#DED7A3]/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#DED7A3]/50"
                >
              ...
              <div>
                <label htmlFor="message" className="block text-[#DED7A3]/80 mb-2">Message</label>
                <textarea
                  id="message"
                  rows="4"
                  className="w-full bg-gray-800 border border-[#DED7A3]/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#DED7A3]/50"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[#DED7A3]/70">
                <li><a href="#aboutus" className="hover:text-[#AD6B08] transition-colors">About Us</a></li>
                <li><a href="#aboutme" className="hover:text-[#AD6B08] transition-colors">Our Coaches</a></li>
                <li><a href="#services" className="hover:text-[#AD6B08] transition-colors">Services</a></li>
                <li><a href="#programs" className="hover:text-[#AD6B08] transition-colors">Programs</a></li>
              </ul>
            </div>
            <div id="contact">
